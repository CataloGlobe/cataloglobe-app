...
// incrementare PRICE_MAP_VERSION. Mai riscrivere lo storico.
//
// Prezzi correnti (USD, valuta di pricing dei provider):
//   - gemini-2.5-flash: $0.30 / 1M token input, $2.50 / 1M token output
//   - deepl:            $25 / 1M caratteri
// =============================================================================

export const PRICE_MAP_VERSION = "2026-07-21.v1";
