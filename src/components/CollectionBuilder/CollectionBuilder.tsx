...
import styles from "./CollectionBuilder.module.scss";
...
export default function CollectionBuilder({ isOpen, collectionId, onClose }: Props) {
    /* ---------------------------------------------------------------------
     * REFS
     * ------------------------------------------------------------------- */
        ...
        >
            ...
            <ModalLayoutContent>
                {tab === "content" && (
                    <>
                        <SectionItemsPanel
                            sectionLabel={sections.find(s => s.id === activeSectionId)?.label ?? ""}
                ...
                <Drawer
                    ...
                    footer={
                        drawer.type === "add" && addDrawerTab === "pick" ? (
                            <Button
                                variant="primary"
                                disabled={pickDiff.add.length === 0 && pickDiff.remove.length === 0}
                    ...
                    {drawer.type === "add" && data && (
                        <AddItemDrawer
                            ...
                            onCreate={async payload => {
                                ...
                                await addItemToCollection(data.collection.id, item.id);
