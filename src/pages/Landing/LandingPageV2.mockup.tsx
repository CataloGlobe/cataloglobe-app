/**
 * LandingPage.tsx — landing page (register BRAND).
 *
...
import s from "./LandingPageV2.mockup.module.scss";
...
const MOCKUP_PRICING_PLANS: MockupPricingPlan[] = [
  {
    ...
    features: [
      ...
      "Import del menu con AI",
      "Aggiorni la disponibilità al volo",
      "Menu in più lingue, automatico",
      "Promozioni programmate",
      "Storie del tuo locale",
      "Recensioni dei clienti",
      "Pagina pubblica del locale",
      "Stile su misura",
      "Più sedi da un posto solo",
    ],
    popular: false,
  },
  {
        ...
        <section className={s.section} id="giornata" aria-labelledby="leve-h2">
          <div className={s.container}>
            <div className={s.sectionLead}>
              <Reveal as="h2" className={s.sectionH2} id="leve-h2" y={16} duration={0.7} amount={0.3} ease="easeOut">
