...
// supabase/functions/_shared/priceSummary.ts. Qualsiasi modifica va
// replicata in ENTRAMBI i file (stesso pattern di resolveActivityCatalogs.ts).
//
...
// Non decide la presentazione ("da X" vs range vs altro) — quella vive in
// formatPriceSummary, separata perché la regola di sintesi può cambiare
// senza toccare questo calcolo.
