// ============================================================
// EXTRACTED SOURCE CODE from:
// src/services/supabase/resolveActivityCatalogs.ts
// ============================================================

// ─── 13. ALL TYPE DEFINITIONS ────────────────────────────────────────────────
...
// ─── 10. normalizeOne and normalizeMany ──────────────────────────────────────
...
// ─── 2. selectVisibilityOverridesWithModeFallback ────────────────────────────
...
// ─── 3. applyVisibilityOverridesToCatalog ────────────────────────────────────
...
// ─── 4. applyPriceOverridesToCatalog ─────────────────────────────────────────
// (includes helper: applyOverridesToOptionGroups)
...
// ─── 5. applyActivityVisibilityOverridesToCatalog ────────────────────────────
...
// ─── 12. computeFromPrice (inside resolveActivityCatalogs) ───────────────────

// NOTE: This function is defined inside the `resolveActivityCatalogs` async function body,
// as a closure. It is NOT a module-level function.
